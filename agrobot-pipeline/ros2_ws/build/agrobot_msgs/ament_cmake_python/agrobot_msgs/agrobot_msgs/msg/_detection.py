    ...
    def top(self, value):
        if __debug__:
            assert \
                ...
                "The 'top' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'top' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._top = value
