...
impl Default for NavPosition_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::NavPosition_Request::default())
  }
}

impl rosidl_runtime_rs::Message for NavPosition_Request {
  type RmwMsg = super::srv::rmw::NavPosition_Request;
...
impl Default for NavPosition_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::srv::rmw::NavPosition_Response::default())
  }
}

impl rosidl_runtime_rs::Message for NavPosition_Response {
  type RmwMsg = super::srv::rmw::NavPosition_Response;
