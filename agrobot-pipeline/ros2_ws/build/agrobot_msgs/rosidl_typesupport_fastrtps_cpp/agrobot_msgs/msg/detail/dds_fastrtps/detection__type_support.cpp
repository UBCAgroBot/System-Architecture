...
#include "agrobot_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agrobot_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agrobot_msgs::msg::Detection & ros_message)
{
  // Member: top
  cdr >> ros_message.top;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agrobot_msgs::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agrobot_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agrobot_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &agrobot_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agrobot_msgs, msg, Detection)() {
  return &agrobot_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
