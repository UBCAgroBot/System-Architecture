...
{
  new (message_memory) agrobot_msgs::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<agrobot_msgs::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[4] = {
  {
    ...
    offsetof(agrobot_msgs::msg::Detection, top),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agrobot_msgs::msg::Detection, left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agrobot_msgs::msg::Detection, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agrobot_msgs::msg::Detection, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  ...
  4,  // number of fields
  sizeof(agrobot_msgs::msg::Detection),
...
get_message_type_support_handle<agrobot_msgs::msg::Detection>()
{
  return &::agrobot_msgs::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agrobot_msgs, msg, Detection)() {
  return &::agrobot_msgs::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
