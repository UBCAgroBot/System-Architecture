...
bool agrobot_msgs__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agrobot_msgs.msg._detection.Detection", full_classname_dest, 37) == 0);
  }
  agrobot_msgs__msg__Detection * ros_message = _ros_message;
  {  // top
    ...
    ros_message->top = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // left
...
PyObject * agrobot_msgs__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agrobot_msgs.msg._detection");
  ...
  {  // top
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->top);
    {
